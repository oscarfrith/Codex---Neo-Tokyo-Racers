-- Neo Tokyo Racers - Edit Mode Day Preview
...
local WINDOW_VARIANT_NAME = "Windows Day"
...
print(string.format(
	"[NTR Lighting Preview] Applied %s in edit mode; updated %d windows and disabled %d lamppost lights.",
	PRESET_NAME,
	windowCount,
	lamppostLightCount
))
