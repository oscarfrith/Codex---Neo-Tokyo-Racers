...
function Runtime.Start()
	...
	local kit=game:GetService("ReplicatedStorage"); local DisplayNames=require(game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Vehicles"):WaitForChild("VehicleDisplayNames")); local categoriesRoot=game:GetService("ReplicatedStorage"):WaitForChild("Assets").Vehicles:WaitForChild("Categories"); local remotes=game:GetService("ReplicatedStorage"):WaitForChild("Remotes").Garage; local invoke=game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Garage"):WaitForChild("OwnedGarageInvoke"); local push=game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Garage"):WaitForChild("OwnedGarageEvent"); local catalog=require(game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Garage"):WaitForChild("OwnedGaragePropertyCatalog")); local styleCatalog=require(game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Garage"):WaitForChild("OwnedGarageInteriorStyleCatalog")); local decorationCatalog=require(game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Garage"):WaitForChild("OwnedGarageDecorationCatalog")); local lightingCatalog=require(game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Garage"):WaitForChild("OwnedGarageLightingCatalog"))
