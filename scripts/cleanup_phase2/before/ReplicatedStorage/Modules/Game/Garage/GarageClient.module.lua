...
local function font()
	local ok, result = pcall(function()
		return Font.new(Theme.FontFamily or require(game:GetService("ReplicatedStorage").Modules.Core.ClientThemeAdapter).DefaultTheme.FontFamily, Enum.FontWeight.Bold, Enum.FontStyle.Normal)
	end)
