...
Current: performance Phase 3 installed, 2026-09-22; user playtest pending. Cleanup phases are confirmed.
...
Current read-only audit: scripts/studio_cleanup_audit.lua. Local naming audit: scripts/audit_cleanup.py. Current exact source/property comparison: scripts/performance_phase3/verify_migration.py. Older exact-baseline verifiers require dependent phase rollback first. Full workflow/limitations: ../10_script_source_sync_workflow.md.
