...
Performance Phase 2 installed, 2026-09-22; user gameplay acceptance pending. All cleanup phases are confirmed.

| Purpose | Canonical script |
|---|---|
| Current migration | scripts/roblox_performance_phase2_server_storage.lua — INSTALL / AUDIT / ROLLBACK |
...
| Current exact parity | scripts/performance_phase2/verify_migration.py |
...
See performance-phase2-server-storage.md. Roll back this delivery before cleanup recovery. Prior index: ../history/cleanup-phase4-prior-docs/installer-index.md.
