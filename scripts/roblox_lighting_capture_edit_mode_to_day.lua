-- Neo Tokyo Racers - Capture Current Edit Lighting To Day
...
local PRESET_NAME = "Day"
local SKY_NAME = "DaySky"
...
if activeSky then
	...
	warn("[NTR Lighting Capture] No Sky found in Lighting; existing DaySky was preserved.")
end
...
print("[NTR Lighting Capture] Saved current edit-mode lighting to Day.")
