...
function Definition.read(config)
    ...
    for _,folder in ipairs(looks:GetChildren()) do
        ...
        points[#points+1]={Name=folder.Name,Preset=folder:GetAttribute("Preset"),Anchor=folder:GetAttribute("Anchor"),OffsetHours=folder:GetAttribute("OffsetHours"),HoldHours=folder:GetAttribute("HoldHours")}
    end
