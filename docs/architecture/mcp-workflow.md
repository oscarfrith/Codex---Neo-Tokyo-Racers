...
Current: cleanup Phase 4 installed, 2026-09-22; user playtest pending.
...
Current read-only audit: scripts/studio_cleanup_audit.lua. Local naming audit: scripts/audit_cleanup.py. Exact Phase 4 source/property comparison: scripts/cleanup_phase4/verify_migration.py. Full workflow/limitations: ../10_script_source_sync_workflow.md.
