...
3. If the task needs live evidence: read docs/architecture/claude-code-setup.md, then list_roblox_studios, choose Space Racers v2 (placeId 71491191583884), get_studio_state. Report place and mode.
