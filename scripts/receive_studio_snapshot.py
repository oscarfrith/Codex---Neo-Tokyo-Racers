#!/usr/bin/env python3
"""
Receive a Roblox full Roblox Studio snapshot export over local HTTP.

Usage:
    python scripts/receive_studio_snapshot.py

Then run this in Roblox Studio:
    scripts/studio_export_snapshot.lua

The Studio exporter sends chunked POSTs to:
    http://127.0.0.1:8765/studio-snapshot-chunk
...
import import_studio_snapshot as importer
...
CHUNK_PATH = "/studio-snapshot-chunk"
...
def main() -> None:
    ...
    print("Leave this window open, then run scripts/studio_export_snapshot.lua in Studio.")
