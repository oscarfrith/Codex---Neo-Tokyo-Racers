-- Neo Tokyo Racers - Racing Phase 11L Arrow Visual Proxy Sync Repair
...
--   No reward config, route-guide config, server collision, matchmaking, VFX,
--   driving, PB persistence, or bootstrap edits.

local PHASE = "NTR Racing Phase 11L Arrow Sync"
...
print("[" .. PHASE .. "] Restart Play and test a solo time trial through checkpoints 1-5. Visual arrows should continue advancing after checkpoint 3.")
