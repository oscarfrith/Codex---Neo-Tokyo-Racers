...
function Runtime.PurchasePoint(profile, moduleInstanceId, module, pathId, baseBuildRaw)
	...
	require(game:GetService("ServerStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Player"):WaitForChild("MoneyService")).Debit(profile, cost, "ModuleUpgrade")
