...
ProfileServer]====]}},
{name=[====[
ActivityService]====],path=[====[
ServerStorage.Modules.Game.Activities.ActivityService]====],dependencies={[====[
ProfileServer]====]}},
{name=[====[
ProgressionService]====],path=[====[
ServerStorage.Modules.Game.Activities.ProgressionService]====],dependencies={[====[
ProfileServer]====]}},
{name=[====[
PassengerService]====],path=[====[
ServerStorage.Modules.Game.Activities.PassengerService]====],dependencies={[====[
ActivityService]====]}},
{name=[====[
JobBoard]====],path=[====[
ServerStorage.Modules.Game.Activities.JobBoard]====],dependencies={[====[
ActivityService]====],[====[
ProgressionService]====]}},
{name=[====[
CourierJob]====],path=[====[
ServerStorage.Modules.Game.Activities.CourierJob]====],dependencies={[====[
ActivityService]====],[====[
ProgressionService]====],[====[
JobBoard]====]}},
{name=[====[
TaxiJob]====],path=[====[
ServerStorage.Modules.Game.Activities.TaxiJob]====],dependencies={[====[
ActivityService]====],[====[
PassengerService]====],[====[
ProgressionService]====],[====[
JobBoard]====]}},
{name=[====[
DuelService]====],path=[====[
ServerStorage.Modules.Game.Activities.DuelService]====],dependencies={[====[
ActivityService]====],[====[
ProgressionService]====]}},
}
