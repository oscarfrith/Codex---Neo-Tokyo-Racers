...
local entries={{name=[====[
ActivityClient]====],path=[====[
ReplicatedStorage.Modules.Game.Activities.ActivityClient]====],dependencies={[====[
SharedTopNotificationUI]====]}},{name="LightingClient",path="ReplicatedStorage.Modules.Game.World.LightingClient",dependencies={}},{name="DriveSessionClient",path="ReplicatedStorage.Modules.Game.Vehicles.DriveSessionClient",dependencies={}},{name=[====[
...
ReplicatedStorage.Modules.Game.UI.MobileFreeRoamHudUI]====],dependencies={}},{name=[====[FullMapUI]====],path=[====[ReplicatedStorage.Modules.Game.UI.FullMapUI]====],dependencies={}},{name=[====[
