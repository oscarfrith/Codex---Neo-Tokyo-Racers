...
local function setCommonEventAttributes(folder, eventId, displayName, mode, routeId)
	...
	folder:SetAttribute("RewardTierMultiplier_E", 1.00)
	folder:SetAttribute("RewardTierMultiplier_D", 1.25)
	folder:SetAttribute("RewardTierMultiplier_C", 1.60)
	folder:SetAttribute("RewardTierMultiplier_B", 2.10)
	folder:SetAttribute("RewardTierMultiplier_A", 2.75)
	folder:SetAttribute("RewardTierMultiplier_S", 3.50)
	folder:SetAttribute("RepeatRewardMultiplier", 0.35)
...
local function setupSampleRouteAndConfig()
	...
	rewards:SetAttribute("BronzeRewardMultiplier", 0.55)
	rewards:SetAttribute("SilverRewardMultiplier", 0.75)
	rewards:SetAttribute("GoldRewardMultiplier", 1.00)
	rewards:SetAttribute("PlatinumRewardMultiplier", 1.30)
	rewards:SetAttribute("FirstPlatinumBonusMultiplier", 1.00)
	rewards:SetAttribute("DNFRewardMultiplier", 0)
	...
	race:SetAttribute("BronzePlaceMax", 3)
	race:SetAttribute("SilverPlaceMax", 2)
	race:SetAttribute("GoldPlaceMax", 1)
	race:SetAttribute("BronzeRewardMultiplier", 0.65)
	race:SetAttribute("SilverRewardMultiplier", 0.85)
	race:SetAttribute("GoldRewardMultiplier", 1.00)
	race:SetAttribute("DNFRewardMultiplier", 0)
