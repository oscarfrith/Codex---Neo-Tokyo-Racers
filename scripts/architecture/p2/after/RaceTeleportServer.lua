...
local Net=require(game:GetService("ServerStorage"):WaitForChild("Modules"):WaitForChild("Core"):WaitForChild("Net")); local handleRaceBrowserTeleport; invoke.OnServerInvoke = Net.invoke({name="RaceBrowserTeleportInvoke",actions={TeleportToRaceStart=true},capacity=10,refill=2,messages={unknown="Unknown race browser teleport action."}}, function(...) return handleRaceBrowserTeleport(...) end); handleRaceBrowserTeleport = function(player, action, payload)
