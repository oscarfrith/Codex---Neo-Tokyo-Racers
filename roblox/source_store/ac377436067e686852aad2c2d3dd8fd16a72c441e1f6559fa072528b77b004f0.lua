...
function Runtime.BuyAndEquip(profile,args,hooks)
	return transact(profile,function()
		...
		require(game:GetService("ServerStorage"):WaitForChild("Modules"):WaitForChild("Game"):WaitForChild("Player"):WaitForChild("MoneyService")).Debit(profile,price,"ModuleInstance")
