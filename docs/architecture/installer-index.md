...
Performance Phase 3 installed, 2026-09-22; user gameplay acceptance pending. All cleanup phases are confirmed.

| Purpose | Canonical script |
|---|---|
| Current migration | scripts/roblox_performance_phase3_catalogue.lua — INSTALL / AUDIT / ROLLBACK |
...
| Current exact parity | scripts/performance_phase3/verify_migration.py |
...
See performance-phase3-catalogue.md. Roll back this delivery before cleanup recovery. Prior index: ../history/cleanup-phase4-prior-docs/installer-index.md.
