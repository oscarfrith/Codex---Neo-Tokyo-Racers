...
local player=Players.LocalPlayer; local kit=game:GetService("ReplicatedStorage"); local categoriesRoot=game:GetService("ReplicatedStorage"):WaitForChild("Assets"):WaitForChild("Vehicles"):WaitForChild("Categories")
