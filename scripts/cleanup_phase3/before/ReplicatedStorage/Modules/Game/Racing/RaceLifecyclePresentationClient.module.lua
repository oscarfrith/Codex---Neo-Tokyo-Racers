...
refresh()
game:GetService("Players").LocalPlayer:WaitForChild("PlayerScripts"):WaitForChild("Runtime"):WaitForChild("Racing"):SetAttribute("NTR_AuraVisibilityOwnerReady",true)
game:GetService("Players").LocalPlayer:WaitForChild("PlayerScripts"):WaitForChild("Runtime"):WaitForChild("Racing"):SetAttribute("NTR_PromptVisibilityOwnerReady",true)
